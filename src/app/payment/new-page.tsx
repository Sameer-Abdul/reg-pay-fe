...
export default function PaymentPage() {
  ...
  // Define initial values with proper types
  ...
  const validationSchema = Yup.object().shape({
    ...
    paymentScreenshot: Yup.mixed()
      .test('required', 'Payment screenshot is required', (value) => {
  ...
  const handleSubmit = async (
    ...
    try {
      ...
      if (response.data.success) {
        ...
        setSubmitError(response.data.message || 'Failed to submit payment');
      }
    } catch (error: any) {
